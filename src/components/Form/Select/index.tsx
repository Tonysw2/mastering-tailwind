    ...
    <SelectPrimitive.Root {...rest}>
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          ...
          sideOffset={8}
          position="popper"
          className="data-[state=close]:animate-slideUpAndFade z-10 w-[--radix-select-trigger-width] animate-slideDownAndFade overflow-hidden rounded-lg border border-zinc-300 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-800"
        >
