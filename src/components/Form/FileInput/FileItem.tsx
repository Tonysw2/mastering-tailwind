  ...
  variants: {
    state: {
      ...
      error: {
        ...
        deleteButton:
          'text-error-700 hover:text-error-900 hover:bg-error-100 dark:text-error-400 dark:hover:text-error-300',
      },
    },
  },
...
type Props = VariantProps<typeof fileItem> & {
  name: string
  size: number
}

export function FileItem({ name, size, state }: Props) {
